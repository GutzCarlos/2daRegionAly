...
function popToFeature(e) {
  var layer = e.target;
  layer.bindPopup(
      "<h5>Localidad:</h5><p>"+ layer.feature.properties.NOM_LOC+
      "</p><br><h5>Municipio: </h5><p>" + layer.feature.properties.NOM_MUN +"</p>"+
      "</p><br><h5>Población (hab.): </h5><p>" + layer.feature.properties.PTOT +"</p>"+
      "</p><br><h5>Distancia (km): </h5><p>" + layer.feature.properties.TiempVj +"</p>"+
      "<h5>Tiempo de traslado (min): </h5><p>" + layer.feature.properties.Distanc +"<p>"+
      "<h5>Google Maps: <a href="+ layer.feature.properties.urlGogl +">Da click aquí</a>"
  );
} 
...
var overlayMaps = {
  ...
  var map = L.map('map', {
    center: [17.83518, -95.48382], /*Default location */
...
L.easyButton('fa-globe', function(btn, map){
  map.setView([17.83518, -95.48382], 10.5);
}).addTo(map);
